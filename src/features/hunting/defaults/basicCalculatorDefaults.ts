...
import { SOL_ERDA_FRAGMENT_ID } from '../lib/huntingExpectationCalculations'
import {
...
export interface DefaultDropItem {
  ...
  dropRate: number // % 단위
  dropRateConstant?: number // 특수 드롭 상수 (% 단위)
...
export const DEFAULT_NORMAL_DROP_ITEMS: DefaultDropItem[] = [
  { id: 'reindeer-milk', name: '순록의 우유', price: 0.275, dropRate: NORMAL_CONSUMABLE_BASE_DROP_RATE, directUse: true, type: 'normal' },
  { id: 'twilight-dew', name: '황혼의 이슬', price: 0.51, dropRate: NORMAL_CONSUMABLE_BASE_DROP_RATE, directUse: true, type: 'normal' },
  { id: 'spell-trace', name: '주문의 흔적', price: 0.2, dropRate: SPELL_TRACE_BASE_DROP_RATE, directUse: false, type: 'normal' }
]

export const DEFAULT_LOG_DROP_ITEMS: DefaultDropItem[] = [
  { id: SOL_ERDA_FRAGMENT_ID, name: '솔 에르다 조각', price: 600, dropRate: SOL_ERDA_FRAGMENT_BASE_DROP_RATE, dropRateConstant: 50, directUse: false, type: 'log' },
  { id: 'core-gemstone', name: '코어 젬스톤', price: 12, dropRate: CORE_GEMSTONE_BASE_DROP_RATE, dropRateConstant: 50, directUse: false, type: 'log' },
  { id: 'symbol', name: '심볼 교환권', price: 20, dropRate: SYMBOL_BASE_DROP_RATE, dropRateConstant: 50, directUse: false, type: 'log' }
]
