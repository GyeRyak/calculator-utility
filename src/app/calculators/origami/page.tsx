...
const title = '메이플스토리 록 스타 돌의 정령 색종이 확률 계산기 | 메이플 계산기';
const description = '메이플스토리 록 스타 돌의 정령 이벤트에서 보유한 알파벳과 색종이 수량, 구매 계획을 반영해 목표 달성 확률과 필요한 색종이 개수의 백분위·예상 비용을 계산합니다.';
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.maplecalc.com/calculators/origami'
  },
  openGraph: {
    title,
    description,
    type: 'website',
    url: 'https://www.maplecalc.com/calculators/origami',
  },
};
